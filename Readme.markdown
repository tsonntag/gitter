...
* facets to be displayed

### Working grid example

[Datagrid DEMO application](http://tracks_grid.heroku.com) is available live!
[Demo source code](https://github.com/tracksun/tracks_grid_demo).
